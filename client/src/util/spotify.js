...
export const playSong = async (uri) => {
    ...
    try {
        ...
        if (
            ...
            console.error(
                'No active device found. Prompting user to activate a device.'
            )
            ...
            alert(
                'No active device found. Please open the Spotify app or activate a device and begin playing music before playing Song Game.'
            )
